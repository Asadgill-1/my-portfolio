      ...
      <div className="mx-auto max-w-content px-6 py-24 md:px-10 md:py-32">
        <div className="grid gap-12 md:grid-cols-[1.5fr_1fr] md:gap-20">
          <Reveal>
            ...
            <h2
              id="about-heading"
              className="max-w-xl font-display text-3xl font-semibold leading-snug tracking-tight text-balance md:text-4xl"
            >
              {site.about.body}
            </h2>
          </Reveal>
            ...
            <dl className="grid grid-cols-3 gap-4 md:grid-cols-1 md:gap-8">
              {site.about.stats.map((stat) => (
                <div key={stat.label} className="border-l border-line pl-5">
                  ...
                  <dd className="mt-1 font-mono text-2xs uppercase tracking-widest text-muted">
                    {stat.label}
                  </dd>
                </div>
              ))}
